<?php
    ...
    */
    ...
    /**
    * Dictionary of Sydney Web Site generator - Main index page (if no specific function designated)
    * 
    * Utilized for browse, citation, preview and popup
    * If last element of the request path is numeric it generates entity page with given ID
    * For browse it redirects to browse.php?name=   otherwise it includes the required script
    * 
    * see .htaccess for behaviour:  RewriteRule ^([^/]+)/([^/]+)$ ?sub=$1&name=$2 [L,NC]
    *
